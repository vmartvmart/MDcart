...
class Returns extends \MDcart\System\Engine\Controller {
	...
	public function info(): ?\MDcart\System\Engine\Action {
		...
		if ($return_info) {
			...
			$data['date_ordered'] = oc_jdate($this->language->get('date_format_short'), strtotime($return_info['date_ordered']));
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'), strtotime($return_info['date_added']));
