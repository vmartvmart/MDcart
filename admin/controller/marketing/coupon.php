...
class Coupon extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		foreach ($results as $result) {
			$data['coupons'][] = [
				'date_start' => oc_jdate($this->language->get('date_format_short'), strtotime($result['date_start'])),
				'date_end'   => oc_jdate($this->language->get('date_format_short'), strtotime($result['date_end'])),
