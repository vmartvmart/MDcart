<?php
namespace MDcart\Admin\Controller\Extension\Opencart\Shipping;
/**
 * Class Weight
 *
 * @package MDcart\Admin\Controller\Extension\Opencart\Shipping
 */
class Weight extends \MDcart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * @return void
