 ...
 */
class Topic extends \MDcart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * @return string
	...
	public function index(): string {
		...
		if ($topics) {
			$data['topics'][] = [
				'topic_id' => 0,
				'name'     => $this->language->get('text_all') . ($this->config->get('module_topic_article_count') ? ' (' . $this->model_cms_article->getTotalArticles() . ')' : ''),
