...
class Marketplace extends \Opencart\System\Engine\Controller {
	...
	public function info(): ?\Opencart\System\Engine\Action {
		...
		if ($response_info) {
			...
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'), strtotime($response_info['date_added']));
			$data['date_modified'] = oc_jdate($this->language->get('date_format_short'), strtotime($response_info['date_modified']));
