 ...
 */
class User extends \MDcart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * @return void
	...
	public function getLogin(): string {
		...
		foreach ($results as $result) {
			$data['logins'][] = ['date_added' => oc_jdate($this->language->get('datetime_format'), strtotime($result['date_added']))] + $result;
		}
