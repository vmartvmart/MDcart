 ...
 */
class Captcha extends \MDcart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * @return void
	...
	public function uninstall(): void {
		...
		if (!$json) {
			...
			$this->model_setting_extension->uninstall('captcha', $code);

			// Call uninstall method if it exists
			$this->load->controller('extension/' . $extension . '/captcha/' . $code . '.uninstall');
