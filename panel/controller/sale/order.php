...
class Order extends \MDcart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = [
				...
				'date_added'      => oc_jdate($this->language->get('date_format_short'), strtotime($result['date_added'])),
	...
	public function info(): void {
		...
		if (!empty($order_info)) {
			...
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'), strtotime($order_info['date_added']));
			$data['date_modified'] = oc_jdate($this->language->get('date_format_short'), strtotime($order_info['date_modified']));
		} else {
			$data['ip'] = '';
			$data['forwarded_ip'] = '';
			$data['user_agent'] = '';
			$data['accept_language'] = '';
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'), time());
			$data['date_modified'] = oc_jdate($this->language->get('date_format_short'), time());
		}
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$data['orders'][] = [
					...
					'date_added'       => oc_jdate($this->language->get('date_format_short'), strtotime($order_info['date_added'])),
