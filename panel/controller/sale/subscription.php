...
class Subscription extends \MDcart\System\Engine\Controller {
	...
	public function info(): void {
		...
		if (!empty($subscription_info)) {
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'), strtotime($subscription_info['date_added']));
		} else {
			$data['date_added'] = oc_jdate($this->language->get('date_format_short'));
		}
	...
	public function getLog(): string {
		...
		foreach ($results as $result) {
			$data['logs'][] = ['date_added' => oc_jdate($this->language->get('date_format_short'), strtotime($result['date_added']))] + $result;
		}
