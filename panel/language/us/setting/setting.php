...
$_['text_trust_badges']                   = 'Trust Badges & License Seals (Footer)';
$_['text_meta']                           = 'Meta Tags';
$_['text_notify_admin']                   = 'New Order Notifications to Team';
...
$_['entry_trust_badge_name']              = 'Badge Name (e.g. Enamad)';
$_['entry_trust_badge_html']              = 'Badge HTML Code';
$_['entry_trust_badge_add']               = 'Add Badge';
$_['entry_trust_badge_sort']              = 'Drag to reorder';
$_['entry_owner']                         = 'Store Owner';
$_['entry_address']                       = 'Address';
$_['entry_geocode']                       = 'Geocode';
$_['entry_google_places_key']             = 'Google Places API Key';
...
$_['entry_currency']                      = 'Pricing Currency (Base)';
$_['entry_currency_display']              = 'Default Display Currency';
...
$_['entry_notify_admin_group']            = 'Roles Notified About New Orders';
...
$_['entry_logo_admin']                    = 'Admin Panel Logo';
$_['entry_icon']                 		  = 'Icon';
...
$_['help_google_places_key']              = 'Optional. Enables Google-powered address autocomplete (including neighbourhood names) on the checkout and address book forms. Get a key with the Places API enabled from the Google Cloud Console (billable beyond the free monthly quota). Leave empty to keep using only the built-in province/county/city picker.';
$_['help_icon']                           = 'The icon should be a PNG that is 16px x 16px.';
$_['help_trust_badges_html']              = 'Click "Add Badge" for each badge (Enamad, business license, payment gateway logos, etc.): give it a name (for your own reference only) and paste the exact HTML code that badge issuer gave you - not a screenshot or a downloaded copy of the image. Each row is shown at the bottom of the site (footer) exactly as pasted. Use the red button next to a row to remove that badge. Drag a row by the grip icon on its left to reorder it - badges are shown on the storefront footer in the same order you arrange them here.';
$_['help_logo_admin']                     = 'Shown only at the top of this admin panel (separate from the store logo). Survives future site updates.';
...
$_['help_currency']                       = 'The currency product prices must be entered in (the "Price" field on the product form). Changing this automatically makes that currency the computation base and rescales every other currency to match its real rate against it; prices already entered are not reinterpreted, so it is best to set this once, early on.';
$_['help_currency_display']               = 'The currency shown to a new customer by default (until they pick a different one from the store\'s currency selector). This can differ from the Pricing Currency above - for example, enter prices in AED but show customers Toman by default. Clear your browser cache to see the change and reset your existing cookie.';
...
$_['help_notify_admin_group']             = 'Any admin user in one of these roles is notified when a new order is placed - by email, and by any of the SMS/Telegram/Bale/WhatsApp channels that have "notify admin" turned on. Each user needs to enter their own email, mobile number and/or Telegram/Bale chat ID once on their own Profile page (top right, username menu > Profile).';
