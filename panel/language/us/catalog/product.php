...
// Tab
$_['tab_warehouse']              = 'Warehouses';

// Text
$_['text_yes']                   = 'Yes';
$_['text_no_warehouses']         = 'No warehouses found. Add one under Catalog > Warehouses.';
$_['text_warehouse_help']        = 'Stock and cost price per warehouse. The Quantity field on the Data tab is read-only here - it always mirrors whichever warehouse is currently marked as the selling warehouse.';
$_['text_quantity_warehouse_note'] = 'Synced automatically from the selling warehouse on the Warehouses tab.';
...
$_['help_condition']             = 'Shown to the customer. If this product is sold both new and used at separate prices/stock, use the Options tab instead and attach the ready-made "Condition" option so the customer can choose between them.';
